...
export interface Env {
  ...
  APP_OIDC_ISSUER_URL?: string
  APP_OIDC_DISCOVERY_URL?: string
  APP_OIDC_AUTHORIZATION_ENDPOINT?: string
  APP_OIDC_TOKEN_ENDPOINT?: string
  APP_OIDC_JWKS_URL?: string
  APP_OIDC_JWKS_JSON?: string
