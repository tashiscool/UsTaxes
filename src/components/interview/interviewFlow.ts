...
export const interviewQuestions: InterviewQuestion[] = [
  ...
  // ============================================================
  {
    ...
    helpText:
      'Your marital status on the last day of the year determines your filing options.',
    whyAskingText:
      'Your marital status affects which filing statuses are available to you and can significantly impact your tax liability.',
  ...
  },
  {
    ...
    helpText:
      'Filing jointly often results in lower taxes, but both spouses are responsible for the accuracy of the return.',
    whyAskingText:
      'Married couples can choose to file jointly or separately. Filing jointly usually results in a lower tax bill.',
    inputType: 'yes_no',
  ...
  },
  {
    ...
    helpText:
      'Dependents include children under 19, full-time students under 24, or relatives you support.',
    whyAskingText:
      'Claiming dependents can qualify you for valuable tax credits like the Child Tax Credit and may affect your filing status.',
    inputType: 'yes_no',
    required: true,
    formSection: 'taxPayer',
    formUrl: Urls.taxPayer.spouseAndDependent
  ...
  },
  {
    ...
    helpText:
      'Children under 17 may qualify for the Child Tax Credit worth up to $2,000 per child.',
    whyAskingText:
      'The Child Tax Credit is only available for qualifying children under age 17 at the end of the tax year.',
    inputType: 'yes_no',
    showIf: [{ questionId: 'has_dependents', value: true }],
    formSection: 'credits'
  },
  ...
  // ============================================================
  {
    ...
    whyAskingText:
      'Filing status is one of the most important factors in calculating your taxes. It affects your tax rates, standard deduction, and eligibility for various credits.',
    inputType: 'multiple_choice',
    options: [
      {
      ...
      },
      {
        ...
        helpText:
          'You are married but want to be responsible only for your own tax'
      },
      {
  ...
  },
  {
    ...
    helpText:
      'If your spouse died recently and you have a dependent child, you may qualify for Qualifying Widow(er) status.',
    inputType: 'yes_no',
  ...
  // ============================================================
  {
    ...
    helpText:
      'This includes any job where you received a W-2 form from your employer.',
    whyAskingText:
      'W-2 income is wages from employment. Your employer withholds taxes and reports your income to the IRS.',
    inputType: 'yes_no',
    required: true,
    formSection: 'w2s',
  ...
  },
  {
    ...
    helpText:
      'Count each W-2 you received. If you had multiple jobs, you will have multiple W-2s.',
    inputType: 'numeric',
    min: 1,
    max: 20,
  ...
  // INCOME - 1099 Income
  {
    ...
    helpText:
      '1099 forms report income from sources other than employment, such as freelance work, investments, or retirement distributions.',
    whyAskingText:
      '1099 forms report various types of income including interest, dividends, self-employment income, and retirement distributions.',
    inputType: 'yes_no',
    required: true,
    formSection: 'f1099s',
  ...
  },
  {
    ...
    helpText:
      'Interest from bank accounts, CDs, or bonds is reported on Form 1099-INT.',
    inputType: 'yes_no',
  ...
  },
  {
    ...
    helpText:
      'Dividends from stocks or mutual funds are reported on Form 1099-DIV.',
    inputType: 'yes_no',
    showIf: [{ questionId: 'had_1099_income', value: true }],
    formSection: 'f1099s',
    formUrl: Urls.income.f1099s
  },
  {
    ...
    category: 'income',
    questionText:
      'Did you sell any stocks, bonds, or other investments (1099-B)?',
    helpText:
      'Sales of investments are reported on Form 1099-B from your broker.',
    inputType: 'yes_no',
    showIf: [{ questionId: 'had_1099_income', value: true }],
    formSection: 'f1099s',
    formUrl: Urls.income.f1099s
  },
  {
    ...
    helpText:
      'Distributions from IRAs, 401(k)s, or pensions are reported on Form 1099-R.',
    inputType: 'yes_no',
    showIf: [{ questionId: 'had_1099_income', value: true }],
    formSection: 'f1099s',
    formUrl: Urls.income.f1099s
  ...
  },
  {
    ...
    category: 'income',
    questionText:
      'Did you have self-employment or freelance income (1099-NEC)?',
    helpText:
      'Non-employee compensation from contract work is reported on Form 1099-NEC.',
    whyAskingText:
      'Self-employment income is subject to self-employment tax in addition to regular income tax.',
    inputType: 'yes_no',
    showIf: [{ questionId: 'had_1099_income', value: true }],
    formSection: 'f1099s',
    formUrl: Urls.income.f1099s
  ...
  // INCOME - Real Estate
  {
    ...
    helpText:
      'Report income from renting out property such as houses, apartments, or rooms.',
    whyAskingText:
      'Rental income is taxable, but you can deduct expenses like mortgage interest, repairs, and depreciation.',
    inputType: 'yes_no',
    required: true,
  ...
  // INCOME - Stock Options
  {
    ...
    helpText:
      'If you exercised incentive stock options (ISOs), you should have received Form 3921.',
    inputType: 'yes_no',
    formSection: 'f3921s',
  ...
  // INCOME - Partnership
  {
    ...
    category: 'income',
    questionText:
      'Are you a partner in a partnership or S-corporation (Schedule K-1)?',
  ...
  // ============================================================
  {
    ...
    helpText:
      'You can either take the standard deduction or itemize. Itemizing makes sense if your itemized deductions exceed the standard deduction.',
    whyAskingText:
      'The standard deduction for 2025 is $15,000 for single filers and $30,000 for married filing jointly. If your itemized deductions are higher, you should itemize.',
    inputType: 'yes_no',
    required: true,
  ...
  },
  {
    ...
    helpText:
      'Mortgage interest on your primary residence (and sometimes a second home) is deductible if you itemize.',
    inputType: 'yes_no',
  ...
  },
  {
    ...
    helpText:
      'You can deduct up to $10,000 of state and local taxes (SALT) if you itemize.',
    inputType: 'yes_no',
    showIf: [{ questionId: 'itemize_deductions', value: true }],
    formSection: 'itemizedDeductions',
    formUrl: Urls.deductions.itemized
  },
  {
    ...
    helpText:
      'Cash and non-cash donations to qualified charities are deductible if you itemize.',
    inputType: 'yes_no',
    showIf: [{ questionId: 'itemize_deductions', value: true }],
    formSection: 'itemizedDeductions',
    formUrl: Urls.deductions.itemized
  ...
  },
  {
    ...
    helpText:
      'You can deduct up to $2,500 of student loan interest even if you take the standard deduction.',
    whyAskingText:
      'Student loan interest is an "above the line" deduction, meaning you can claim it even if you do not itemize.',
    inputType: 'yes_no',
    required: true,
    formSection: 'f1098es',
  ...
  // ============================================================
  {
    ...
    helpText:
      'HSA contributions are tax-deductible and can be used for qualified medical expenses.',
    whyAskingText:
      'HSA contributions reduce your taxable income. You can contribute if you have a high-deductible health plan.',
    inputType: 'yes_no',
  ...
  },
  {
    ...
    helpText:
      'Traditional IRA contributions may be tax-deductible. Roth IRA contributions are not deductible but grow tax-free.',
    inputType: 'yes_no',
  ...
  // ============================================================
  {
    ...
    category: 'credits',
    questionText:
      'Based on your dependents, you may be eligible for the Child Tax Credit. Would you like to claim it?',
    helpText:
      'The Child Tax Credit is worth up to $2,000 per qualifying child under 17.',
    inputType: 'yes_no',
  ...
  },
  {
    ...
    category: 'credits',
    questionText:
      'Would you like us to check if you qualify for the Earned Income Tax Credit (EITC)?',
    helpText:
      'The EITC is a refundable credit for low to moderate income workers. It can be worth up to $7,830 for 2025.',
    whyAskingText:
      'The EITC is one of the largest credits available and is fully refundable, meaning you can get it even if you owe no taxes.',
    inputType: 'yes_no',
    formSection: 'credits'
  },
  ...
  // ============================================================
  {
    ...
    helpText:
      'If you paid estimated taxes quarterly, those payments will be credited toward your tax bill.',
    inputType: 'yes_no',
  ...
  // ============================================================
  {
    ...
    helpText:
      'Your state of residence determines if you need to file a state tax return.',
    whyAskingText:
      'Most states require you to file a state income tax return in addition to your federal return.',
    inputType: 'text',
    required: true,
  ...
  },
  {
    ...
    helpText:
      'If you moved between states, you may need to file part-year resident returns in multiple states.',
    inputType: 'yes_no',
    formSection: 'stateResidencies'
  },
  ...
  // ============================================================
  {
    ...
    category: 'review',
    questionText:
      'Have you reviewed all your information and are ready to generate your tax forms?',
    helpText:
      'Make sure all information is accurate before generating your tax forms.',
    inputType: 'yes_no',
...
export const getCategoryById = (
  id: QuestionCategory
): InterviewCategory | undefined => interviewCategories.find((c) => c.id === id)
