...
const parameters = {
  ...
  taxBrackets: {
    [FilingStatus.S]: {
      ...
      rates: [0.014, 0.032, 0.055, 0.064, 0.068, 0.072, 0.076, 0.079, 0.0825, 0.09, 0.10, 0.11]
    },
    [FilingStatus.MFJ]: {
      brackets: [4800, 9600, 19200, 28800, 38400, 48000, 72000, 96000, 300000, 350000, 400000],
      rates: [0.014, 0.032, 0.055, 0.064, 0.068, 0.072, 0.076, 0.079, 0.0825, 0.09, 0.10, 0.11]
    },
    [FilingStatus.MFS]: {
      brackets: [2400, 4800, 9600, 14400, 19200, 24000, 36000, 48000, 150000, 175000, 200000],
    ...
    [FilingStatus.HOH]: {
      brackets: [3600, 7200, 14400, 21600, 28800, 36000, 54000, 72000, 225000, 262500, 300000],
      rates: [0.014, 0.032, 0.055, 0.064, 0.068, 0.072, 0.076, 0.079, 0.0825, 0.09, 0.10, 0.11]
    },
    [FilingStatus.W]: {
      brackets: [4800, 9600, 19200, 28800, 38400, 48000, 72000, 96000, 300000, 350000, 400000],
