 ...
 *
 * Mississippi uses progressive rates: 0% on first $10,000, 4.7% above
 * Moving to flat 4% by 2026
 */
export class MS80105 extends Form {
  ...
  // Line 6: Social Security benefits (Mississippi fully exempts SS)
  l6 = (): number | undefined => this.f1040.l6b() ?? undefined

  // Line 7: Retirement income exemption (qualified plans fully exempt)
  l7 = (): number | undefined => {
    const retirementIncome = this.f1040.l5b() ?? 0
    return retirementIncome > 0 ? retirementIncome : undefined
  }
  ...
  // Line 10: Mississippi adjusted gross income
  ...
  l11 = (): number => {
    ...
    // Mississippi allows itemizing (uses federal Schedule A)
  ...
  // Line 13: Mississippi taxable income
  l13 = (): number => Math.max(0, this.l10() - this.l11() - this.l12())

  // Line 14: Mississippi tax (0% up to $10,000, 4.7% above)
  ...
  // PAYMENTS
  // Line 19: Mississippi withholding
  l19 = (): number | undefined => this.methods.witholdingForState('MS')
...
const makeMS80105 = (f1040: F1040): MS80105 => new MS80105(f1040)

export default makeMS80105
