...
export default class StudentLoanInterestWorksheet {
  ...
  // 2025: Phase-out starts at $170,000 MFJ, $85,000 others
  // Source: IRS Rev Proc 2024-40, consistent with direct-file studentLoanAdjustment.xml
  l5 = (): number =>
    this.f1040.info.taxPayer.filingStatus === FilingStatus.MFJ ? 170000 : 85000

  l6 = (): number => Math.max(0, this.l4() - this.l5())

  // 2025: Phase-out range is $30,000 MFJ, $15,000 others
  // MFJ completes at $200,000, others at $100,000
  phaseOutRange = (): number =>
    this.f1040.info.taxPayer.filingStatus === FilingStatus.MFJ ? 30000 : 15000

  l7 = (): number => Math.min(this.l6() / this.phaseOutRange(), 1)
