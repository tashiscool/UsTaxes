...
const depreciation = {
  ...
  bonusDepreciationRate: 0.40  // 40% for 2025
}

export type DepreciationMethod = 'MACRS' | 'straightLine' | 'section179' | 'bonus'
export type PropertyClass = '3year' | '5year' | '7year' | '10year' | '15year' | '20year' | '25year' | '27.5year' | '39year'
...
export default class F4562 extends F1040Attachment {
  ...
  assets = (): DepreciableAsset[] => {
    return (this.f1040.info.depreciableAssets as DepreciableAsset[] | undefined) ?? []
  }
  ...
  l11 = (): number => {
    ...
    const schedCIncome = this.f1040.scheduleC?.l31() ?? 0
  ...
  l17 = (): number => {
    ...
    return currentYearAssets.reduce((sum, a) => sum + a.currentYearDepreciation, 0)
  }
  ...
  l18 = (): number => {
    ...
    return priorYearAssets.reduce((sum, a) => sum + a.currentYearDepreciation, 0)
  }
  ...
  l21 = (): number => sumFields([
    this.l12(), this.l14(), this.l15(), this.l16(), this.l20()
  ])
