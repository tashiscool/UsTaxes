...
// 2025 passive activity loss limits
...
export default class F8582 extends F1040Attachment {
  ...
  // Net passive income (used by F8582CR)
  netPassiveIncome = (): number => {
    return Math.max(0, this.l3())
  }

  // Special allowance used (used by F8582CR)
  specialAllowanceUsed = (): number => this.l11()
