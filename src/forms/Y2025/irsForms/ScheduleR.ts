...
const scheduleRParams = {
  ...
  agiReductionRate: 0.50,             // 50% of excess AGI
...
export default class ScheduleR extends F1040Attachment {
  ...
  filingCategory = (): number => {
    ...
    if (fs === FilingStatus.MFJ) {
      ...
      return 6  // Box 6: MFS
    } else if (fs === FilingStatus.HOH || fs === FilingStatus.S || fs === FilingStatus.W) {
  ...
  l10 = (): number => {
    ...
    switch (category) {
      case 1: return scheduleRParams.initialAmountSingle  // $5,000
      case 2: return scheduleRParams.initialAmountMfjBoth  // $7,500
      case 3: return scheduleRParams.initialAmountMfjOne   // $5,000
      case 6: return scheduleRParams.initialAmountMfs      // $3,750
      default: return 0
    }
  }
