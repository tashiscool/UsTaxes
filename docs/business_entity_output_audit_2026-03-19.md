...
| `990` | Capability gating, review support, blocked submit, and nonprofit family sizing hints (`990-N`, `990-EZ`, or full `990`) | `/Users/tkhan/IdeaProjects/taxes/UsTaxes/backend-cloudflare/src/services/taxCalculationService.ts`, `/Users/tkhan/IdeaProjects/taxes/UsTaxes/backend-cloudflare/src/services/appSessionService.ts`, `/Users/tkhan/IdeaProjects/taxes/UsTaxes/backend-cloudflare/test/worker/cloudflareRuntime.e2e.test.ts`, `/Users/tkhan/IdeaProjects/taxes/UsTaxes/backend-cloudflare/test/service/businessParityFixtures.test.ts`, `/Users/tkhan/IdeaProjects/taxes/UsTaxes/backend-cloudflare/test/service/taxCalculationService.businessEntities.test.ts` | Honest expert-only routing is in place and now fixture-backed for full-`990`, `990-EZ`-sized, and `990-N`-sized organizations instead of being only a prose claim. | Not self-serve; cannot support a “100% self-service” production claim, and still lacks workbook-backed nonprofit parity. |
