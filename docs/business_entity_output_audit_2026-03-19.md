...
| `990` | Capability gating, review support, blocked submit, nonprofit family sizing hints (`990-N`, `990-EZ`, or full `990`), checklist/review preview rows for rendered nonprofit totals and identity fields, plus rendered local-form totals and identity fields for `F990`, `F990EZ`, and `F990N` | `/Users/tkhan/IdeaProjects/taxes/UsTaxes/backend-cloudflare/src/services/taxCalculationService.ts`, `/Users/tkhan/IdeaProjects/taxes/UsTaxes/backend-cloudflare/src/services/appSessionService.ts`, `/Users/tkhan/IdeaProjects/taxes/UsTaxes/backend-cloudflare/test/worker/cloudflareRuntime.e2e.test.ts`, `/Users/tkhan/IdeaProjects/taxes/UsTaxes/backend-cloudflare/test/service/businessParityFixtures.test.ts`, `/Users/tkhan/IdeaProjects/taxes/UsTaxes/backend-cloudflare/test/service/taxCalculationService.businessEntities.test.ts`, `/Users/tkhan/IdeaProjects/taxes/UsTaxes/src/forms/Y2025/tests/F990FamilyParity.test.ts` | Honest expert-only routing is in place and now fixture-backed for full-`990`, `990-EZ`-sized, and `990-N`-sized organizations instead of being only a prose claim. Worker review/checklist responses now surface render-oriented nonprofit preview values such as suggested return variant, rendered revenue, net assets, and principal-officer identity where the facts support them, while local rendered-form tests continue to prove nonprofit totals, balance-sheet values, identity outputs, and e-postcard eligibility across the `990` family. | Not self-serve in the Cloudflare production path and still lacks private-workbook-backed nonprofit parity. |
