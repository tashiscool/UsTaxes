...
| 990 | no | 48 | 0 | 6 | 2 | irs_reference_only | Nonprofit parity is partially implemented in local forms, but Cloudflare still routes Form 990-family work to expert handling. |
